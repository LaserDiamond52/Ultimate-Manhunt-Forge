...
public class PlayerSpeedRunner extends AbstractCapabilityData<PlayerSpeedRunner> {
    ...
    private static boolean BUFFED_HUNTER_ON_FINAL_DEATH = false; // Does the speed runner become a buffed hunter after losing their final life?
    ...
    public static boolean setIsBuffedHunterOnFinalDeath(boolean isBuffedHunter)
    {
        ...
        BUFFED_HUNTER_ON_FINAL_DEATH = isBuffedHunter;
        return true;
    }
