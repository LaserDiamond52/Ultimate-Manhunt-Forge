...
public class ClientSettings {
    ...
    public static final class SoundController extends FloatBooleanController
    {
        ...
        private SoundController(float initValue, boolean initEnabled, BiConsumer<Float, Boolean> onValueChange, BiConsumer<Float, Boolean> onBooleanChange, RegistryObject<SoundEvent> soundEvent)
        {
            super(initValue, initEnabled, onValueChange, onBooleanChange);
     ...
     */
    public static final SoundController START_GAME_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.GAME_START), adjustVolume(UMSoundEvents.GAME_START), UMSoundEvents.GAME_START);

    /**
     * Controls for the {@linkplain UMSoundEvents#GAME_PAUSE Game Pause Sound}
     */
    public static final SoundController PAUSE_GAME_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.GAME_PAUSE), adjustVolume(UMSoundEvents.GAME_PAUSE), UMSoundEvents.GAME_PAUSE);

    /**
     * Controls for the {@linkplain UMSoundEvents#GAME_RESUME Game Resume Sound}
     */
    public static final SoundController RESUME_GAME_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.GAME_RESUME), adjustVolume(UMSoundEvents.GAME_RESUME), UMSoundEvents.GAME_RESUME);

    /**
     * Controls for the {@linkplain UMSoundEvents#GAME_END Game End Sound}
     */
    public static final SoundController END_GAME_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.GAME_END), adjustVolume(UMSoundEvents.GAME_END), UMSoundEvents.GAME_END);

    /**
     * Controls for the {@linkplain UMSoundEvents#HUNTER_RELEASED Hunters Released Sound}
     */
    public static final SoundController HUNTERS_RELEASED_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.HUNTER_RELEASED), adjustVolume(UMSoundEvents.HUNTER_RELEASED), UMSoundEvents.HUNTER_RELEASED);

    /**
     * Controls for the {@linkplain UMSoundEvents#HEART_BEAT Heart Beating Sound}
     */
    public static final SoundController HEART_BEAT_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.HEART_BEAT), adjustVolume(UMSoundEvents.HEART_BEAT), UMSoundEvents.HEART_BEAT);

    /**
     * Controls for the {@linkplain UMSoundEvents#HEAT_BEAT_FLATLINE Heart Flatlining Sound}
     */
    public static final SoundController HEART_FLATLINE_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.HEAT_BEAT_FLATLINE), adjustVolume(UMSoundEvents.HEAT_BEAT_FLATLINE), UMSoundEvents.HEAT_BEAT_FLATLINE);

    /**
     * Controls for the {@linkplain UMSoundEvents#HUNTER_DETECTED Prowler Theme (Hunter Detection Music)}
     */
    public static final SoundController PROWLER_VOLUME = new SoundController(1.0f, true, adjustVolume(UMSoundEvents.HUNTER_DETECTED), adjustVolume(UMSoundEvents.HUNTER_DETECTED), UMSoundEvents.HUNTER_DETECTED);
